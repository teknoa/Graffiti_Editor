...
//
//==============================================================================
// $Id: GraphConstraintChecker.java,v 1.1 2007/06/14 09:36:47 klukas Exp $
        ...
        AttributeListener
{
     ...
     *
     * @param g the <code>Graph</code> on which to check the constraints.
     * @param ccl the <code>ConstraintCheckerListener</code> receiving failures
     *        of constraints.
     */
     ...
     * checker.
     *
     * @param c the <code>GraphConstraint</code> to be added to the set of
     ...
     * constraints of this constraint checker.
     *
     * @param c the <code>GraphConstraint</code> to be removed.
     *
     * @exception NoSuchElementException if the constraint checker does not
