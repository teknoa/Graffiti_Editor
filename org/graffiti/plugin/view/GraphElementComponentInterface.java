...
//
//==============================================================================
// $Id: GraphElementComponentInterface.java,v 1.5 2010/07/19 14:05:42 morla Exp $
...
public interface GraphElementComponentInterface
{
	...
	/**
	 * Adds an <code>Attribute</code> and its
	 * <code>GraffitiViewComponent</code> to the list of registered attributes
	 * that can be displayed.  This attribute is then treated as dependent on
	 * the position, size etc.  of this <code>GraphElement</code>.
	 *
	 * @param attr the attribute that is registered as being able to  be
	 *        displayed.
	 * @param ac the component that will be used to display the attribute.
	 */
	 ...
	 * target nodes.
	 *
	 * @param comp the <code>GraphElementComponent</code> that is added to the
	 ...
	 * component has changed.
	 *
	 * @param attr the graphic attribute that has triggered the event.
	 *
	 * @throws ShapeNotFoundException DOCUMENT ME!
	 */
	...
	/**
	 * Removes a <code>GraffitiViewComponent</code> of an
	 * <code>Attribute</code> from collection of attribute components.
	 *
	 * @param attr the attribute that has to be removed
	 */
	 ...
	 * <code>GraphElementComponent</code>s.
	 *
	 * @param comp the <code>GraphElementComponent</code> that is removed from
