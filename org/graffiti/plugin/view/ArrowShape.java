...
//
//==============================================================================
// $Id: ArrowShape.java,v 1.1 2007/06/14 09:36:44 klukas Exp $
    ...
    extends Shape
{
     ...
     *
     * @param target the point where the arrow should be put
     * @param other needed to calculate the direction in which the arrow should
     *        point to. The line is given by the two points target and other.
     * @param lineWidth The total width of the line. May be used to scale the
